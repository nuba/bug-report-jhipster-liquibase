package bug.report.repository;

import bug.report.JhipsterApp;
import bug.report.config.Constants;
import bug.report.config.audit.AuditEventConverter;
import bug.report.domain.PersistentAuditEvent;
...
import static bug.report.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
